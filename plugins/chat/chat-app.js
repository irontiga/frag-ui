(function () {
  ...
  */
   ...
   * @const {Promise<void>}
   */
  const promise$1 = Promise.resolve();
    ...
    class LegacyElement extends legacyElementBase {
      ...
      arrayDelete(arrayOrPath, item) {
        ...
        if (Array.isArray(arrayOrPath)) {
          ...
          let arr = get$1(this, arrayOrPath);
  ...
  */
   ...
   */
  const html$2 = function html(strings, ...values) {
...
`,
  ...
  */
  ...
  found at http://polymer.github.io/PATENTS.txt
  */
  const template = html$2`<custom-style>
...
`,
  ...
  */
  ...
  const template$5 = html$2`<iron-iconset-svg name="icons" size="24">
<svg><defs>
  ...
  class ChatApp extends LitElement {
    ...
    render() {
      return html$1`
            ...
            <div id="chat">
                <div id="messages">
                    ${this.messages.map(message => html$1`
    ...
    firstUpdated() {
      ...
      parentEpml.subscribe('logged_in', isLoggedIn => {
        ...
        fetch('http://' + window.location.hostname + ':' + serverPort + '/messages').then(res => res.json()).then(messages => {
    ...
    send() {
      ...
      fetch('http://' + window.location.hostname + ':' + serverPort + '/messages', {
        ...
        this.sending = false; // eslint-disable-next-line no-throw-literal
